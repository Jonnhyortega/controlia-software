        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-primary-300 font-medium">Sistema de Gestión Empresarial</span>
            </motion.div>
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-xl">
              La plataforma todo-en-uno diseñada para kioscos, almacenes y ferreterías. Gestiona productos, proveedores, ventas y cierres de caja desde un solo lugar.
            </p>
