...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    'Recursos': ['Documentación', 'Tutoriales', 'Centro de ayuda', 'API'],
    'Legal': ['Privacidad', 'Términos', 'Seguridad', 'Cookies']
  };

  return (
    <footer className="bg-[#0f0f12] border-t border-gray-800">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          {Object.entries(footerLinks).map(([category, links], index) => (
            ...
            >
              <span className="text-white font-semibold text-sm mb-4 block">{category}</span>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {currentYear} CONTROLIA. Todos los derechos reservados.
            </p>
